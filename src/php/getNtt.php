...
$sql = "select d.ntt_name as name,sum(b.amount) as weight from nutrition d,dish c, orders a,order_detail b where b.dish_id=c.dish_id and a.order_id = b.order_id and year(a.order_time) = ? and month(a.order_time) = ? and day(a.order_time) = ? and d.ntt_id = c.dish_nutrition_id and a.user_id = ? and a.order_status = 4 group by d.ntt_name;";
